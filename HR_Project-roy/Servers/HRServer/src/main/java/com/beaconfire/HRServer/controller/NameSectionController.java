...
public class NameSectionController {
    ...
    public NameSectionResponse getInitialFormValue(@RequestParam String eid) throws EmploymentStartDateNotFoundException {
    ...
    public NameSectionResponse getContactInfoValue(@RequestParam String eid) throws EmploymentStartDateNotFoundException {
    ...
    public NameSectionResponse getEmploymentInfo(@RequestParam String eid) throws EmploymentStartDateNotFoundException {
    ...
    public NameSectionResponse getEmergencyContactInfo(@RequestParam String eid) throws EmploymentStartDateNotFoundException {
